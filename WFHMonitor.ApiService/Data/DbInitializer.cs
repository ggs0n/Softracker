...
public static class DbInitializer
{
    ...
    private static async Task EnsureSchemaColumnsAsync(ApplicationDbContext db)
    {
        ...
        await db.Database.ExecuteSqlRawAsync("""
            ...
            BEGIN
                ...
                (
                    ...
                    [EnableAiAutomation] bit NOT NULL CONSTRAINT [DF_SystemPreferences_EnableAiAutomation] DEFAULT 1,
                    [AllowAiAutomationForFreePlan] bit NOT NULL CONSTRAINT [DF_SystemPreferences_AllowAiAutomationForFreePlan] DEFAULT 0,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            IF OBJECT_ID(N'[dbo].[SystemPreferences]', N'U') IS NOT NULL
               AND COL_LENGTH('SystemPreferences', 'EnableOpenClawAgents') IS NOT NULL
               AND COL_LENGTH('SystemPreferences', 'EnableAiAutomation') IS NULL
            BEGIN
                EXEC sp_rename
        ...
        await db.Database.ExecuteSqlRawAsync("""
            ...
            BEGIN
                ALTER TABLE [dbo].[SystemPreferences]
                    ADD [EnableAiAutomation] bit NOT NULL
                    CONSTRAINT [DF_SystemPreferences_EnableAiAutomation] DEFAULT 1;
            END
            """);

        await db.Database.ExecuteSqlRawAsync("""
            IF OBJECT_ID(N'[dbo].[SystemPreferences]', N'U') IS NOT NULL
               AND COL_LENGTH('SystemPreferences', 'AllowOpenClawForFreePlan') IS NOT NULL
               AND COL_LENGTH('SystemPreferences', 'AllowAiAutomationForFreePlan') IS NULL
            BEGIN
                EXEC sp_rename
        ...
        await db.Database.ExecuteSqlRawAsync("""
            ...
            BEGIN
                ALTER TABLE [dbo].[SystemPreferences]
                    ADD [AllowAiAutomationForFreePlan] bit NOT NULL
                    CONSTRAINT [DF_SystemPreferences_AllowAiAutomationForFreePlan] DEFAULT 0;
            END
            """);
        ...
        await db.Database.ExecuteSqlRawAsync("""
            ...
            BEGIN
                INSERT INTO [dbo].[SystemPreferences]
                    ([Id], [BellNotificationSoundEnabled], [BellNotificationSoundOption], [FreeProjectLimit], [FreeBugLimit], [FreeFeatureLimit], [EnableAiAutomation], [AllowAiAutomationForFreePlan], [UpdatedAt])
                VALUES
