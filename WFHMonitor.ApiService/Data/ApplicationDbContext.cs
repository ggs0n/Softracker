...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    public DbSet<BrainstormDesignProject> BrainstormDesignProjects =>
        Set<BrainstormDesignProject>();
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<SystemPreference>(e =>
        {
            ...
            e.Property(s => s.EnableAiAutomation)
                .HasDefaultValue(true);

            e.Property(s => s.AllowAiAutomationForFreePlan)
                .HasDefaultValue(false);
        });
        ...
        builder.Entity<BrainstormDesignProject>(e =>
        {
            e.HasKey(project => project.Id);
            e.HasIndex(project => project.CreatedById);
            ...
            e.Property(project => project.Title)
                .HasMaxLength(180)
                .IsRequired();
            e.Property(project => project.Summary)
                .HasColumnType("nvarchar(max)")
                .IsRequired();
            e.Property(project => project.Technology)
                .HasColumnType("nvarchar(max)")
                .IsRequired();
            e.Property(project => project.CloudHostingTarget)
                .HasMaxLength(120);
            e.Property(project => project.UserCount)
                .HasMaxLength(100)
                .IsRequired();
            e.Property(project => project.Features)
                .HasColumnType("nvarchar(max)")
                .IsRequired();
            e.Property(project => project.BlueprintJson)
                .HasColumnType("nvarchar(max)")
                .IsRequired();
            e.Property(project => project.SourceMode)
                .HasMaxLength(40)
                .IsRequired();
            e.Property(project => project.CreatedAt)
                .IsRequired();
            e.Property(project => project.CreatedById)
                .HasMaxLength(450)
                .IsRequired();

            e.HasOne(project => project.CreatedBy)
                .WithMany()
