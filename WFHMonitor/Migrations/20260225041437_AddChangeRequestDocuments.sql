...
ALTER TABLE [ChangeRequests] ADD [Stage] int NOT NULL DEFAULT 0;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260225035227_AddChangeRequestStage', N'8.0.0');
GO
...
CREATE TABLE [ChangeRequestDocuments] (
    [Id] int NOT NULL IDENTITY,
    [ChangeRequestId] int NOT NULL,
    [FileName] nvarchar(300) NOT NULL,
    [OriginalFileName] nvarchar(300) NOT NULL,
    [UploadedAt] datetime2 NOT NULL,
    CONSTRAINT [PK_ChangeRequestDocuments] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_ChangeRequestDocuments_ChangeRequests_ChangeRequestId] FOREIGN KEY ([ChangeRequestId]) REFERENCES [ChangeRequests] ([Id]) ON DELETE CASCADE
);
GO

CREATE INDEX [IX_ChangeRequestDocuments_ChangeRequestId] ON [ChangeRequestDocuments] ([ChangeRequestId]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260225041437_AddChangeRequestDocuments', N'8.0.0');
GO
